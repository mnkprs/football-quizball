...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'duel', loadComponent: () => import('./features/duel/duel-lobby').then(m => m.DuelLobbyComponent) },
    ],
  },
  { path: 'game', loadComponent: () => import('./features/game/game').then(m => m.GameComponent) },
  { path: 'online-game', loadComponent: () => import('./features/online-game/online-lobby').then(m => m.OnlineLobbyComponent) },
  { path: 'online-game/:id', loadComponent: () => import('./features/online-game/online-play').then(m => m.OnlinePlayComponent) },
  { path: 'join/:code', loadComponent: () => import('./features/online-game/join-invite').then(m => m.JoinInviteComponent) },
  { path: 'duel/:id', loadComponent: () => import('./features/duel/duel-play').then(m => m.DuelPlayComponent) },
  { path: 'battle-royale', loadComponent: () => import('./features/battle-royale/battle-royale-lobby').then(m => m.BattleRoyaleLobbyComponent) },
  { path: 'battle-royale/:id', loadComponent: () => import('./features/battle-royale/battle-royale-play').then(m => m.BattleRoyalePlayComponent) },
