...
const TRANSLATIONS = {
  ...
  el: {
    ...
    // Solo
    soloTitle: 'Solo Ranked',
    soloSubtitle: 'Απάντησε σε ποδοσφαιρικές ερωτήσεις για να κερδίσεις ELO και να ανέβεις στην κατάταξη.',
    soloBullet1: 'Πληκτρολόγησε τις απαντήσεις σου — χωρίς πολλαπλή επιλογή',
    soloBullet2: 'Προσαρμοστική δυσκολία: ΕΥΚΟΛΟ (10δ), ΜΕΤΡΙΟ (15δ), ΔΥΣΚΟΛΟ (20δ)',
    soloBullet3: 'Κέρδισε ELO σε σωστές απαντήσεις, χάσε σε λάθος ή timeout',
    soloBullet4: 'Παίξε όσες ερωτήσεις θέλεις ανά συνεδρία',
    soloStartingElo: 'Αρχικό ELO:',
    soloStarting: 'Έναρξη...',
    soloStartPlaying: 'Έναρξη Παιχνιδιού',
    soloYourAnswer: 'Η απάντησή σου...',
    soloTimesUp: 'Τέλος χρόνου!',
    soloAnswerLabel: 'Απάντηση:',
    soloEloChange: 'Αλλαγή ELO',
    soloNewElo: 'Νέο ELO',
    soloNextQuestion: 'Επόμενη Ερώτηση',
    soloEnd: 'Τέλος',
    soloSessionComplete: 'Ολοκλήρωση Συνεδρίας',
    soloStartingEloLabel: 'Αρχικό ELO',
    soloFinalElo: 'Τελικό ELO',
    soloViewLeaderboard: 'Προβολή Κατάταξης',
    soloPlayAgain: 'Παίξε Ξανά',
    soloOk: 'OK',
    soloBackBtn: '← Αρχική',
    soloCorrect: 'Σωστό!',
    soloWrong: 'Λάθος',
    soloCorrectCount: 'Σωστές',
    soloEasy: 'ΕΥΚΟΛΟ',
    soloMedium: 'ΜΕΤΡΙΟ',
    soloHard: 'ΔΥΣΚΟΛΟ',
    // Leaderboard
