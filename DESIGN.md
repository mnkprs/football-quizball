...
│  ┌────────────────────────┐  │
│  │ Duel Mode          ›   │  │  ← Mode row, lime border
...
### Typography
- [x] Space Grotesk for all headlines (added full weight range to index.html)
- [x] Keep Inter for body (already in use)
- [x] Lexend for label/data layer (chips, timers, eyebrows) — added to index.html
- [x] Google Fonts updated in `index.html`

### Color
- [ ] Update all CSS custom properties in tailwind.css
...
### Pages
- [ ] Profile screen
- [x] Leaderboard screen — rebuilt with design system
- [ ] Login / Auth screen
