...
Prefer well-known matches so players can recall the score.${getSingleAnswerInstruction()}${getAntiConvergenceInstruction('GUESS_SCORE')}${getCompactQuestionInstruction()}
Return ONLY valid JSON:
{
  "questions": [
    {
